...
fn prepare_command(
    ...
    let mut prepared = {
        ...
        prepared.arg("-NoProfile").arg("-Command").arg(command);
        prepared
    };
    ...
    if sandbox_status.filesystem_active {
        ...
        #[cfg(windows)]
        prepared
            .env("TMP", cwd.join(".sandbox-tmp"))
            .env("TEMP", cwd.join(".sandbox-tmp"));
        #[cfg(not(windows))]
